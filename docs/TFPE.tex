...
\title{Crafting Tools for Data Management and Evaluation}
...
\hypersetup{
  pdftitle={Crafting Tools for Data Management and Evaluation},
  pdfauthor={Kevin W Gilds, MPA},
  hidelinks,
...
\hypertarget{origin-story}{%
\chapter{Origin Story}\label{origin-story}}
